...
<!-- Основний контент сторінки -->
 <section class="main-page victory-page">
     ...
     <h1 class="main-page-title1">Вітаємо!</h1>
     <p class="main-page-descr1">Ви знайшли Амулет Сонця та врятували королівство від Темного мага. Ваша слава буде вічною!</p>
     ...
     <img src="./img/Licar.webp" alt="Victory Image" class="victory-image">
     </div>
